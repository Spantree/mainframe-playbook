...
Known gaps: WRITE AFTER ADVANCING has a GLR ambiguity in some edge cases, intrinsic FUNCTION calls are partially supported, and free-form COBOL dialect is not supported.

The grammar is MIT licensed and available at [github.com/Spantree/tree-sitter-cobol-enterprise](https://github.com/Spantree/tree-sitter-cobol-enterprise). It derives from tree-sitter-cobol by Yutaro Sakamoto (also MIT). Both copyright notices are in the LICENSE file.
